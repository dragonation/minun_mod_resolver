...
Object.defineProperty(Float24Vector.prototype, "x", {
    "enumerable": true,
    "get": function () {
        if (this.settled && this._x) {
            return this._x[0];
        }
        let word2 = this.words[2]; if (@.is.nil(word2)) word2 = 0;
        this._x = [Float24Vector.getFloat(word2 & 0xffffff)];
        return this._x[0];
    }
});
...
Object.defineProperty(Float24Vector.prototype, "z", {
    "enumerable": true,
    "get": function () {
        if (this.settled && this._z) {
            return this._z[0];
        }
        let word1 = this.words[1]; if (@.is.nil(word1)) word1 = 0;
        let word0 = this.words[0]; if (@.is.nil(word0)) word0 = 0;
        this._z = [Float24Vector.getFloat((word1 >> 16) & 0xffff | ((word0 & 0xff) << 16))];
        return this._z[0];
    }
});
...
Object.defineProperty(Float24Vector.prototype, "w", {
    "enumerable": true,
    "get": function () {
        if (this.settled && this._w) {
            return this._w[0];
        }
        let word0 = this.words[0]; if (@.is.nil(word0)) word0 = 0;
        this._w = [Float24Vector.getFloat((word0 >> 8) & 0xffffff)];
        return this._w[0];
    }
});
...
const LightingLUTInputAbsolute = function LightingLUTInputAbsolute(code) {
    ...
    this.reflectB = (code & 0x00020000) === 0;
    this.reflectG = (code & 0x00200000) === 0;
    this.reflectR = (code & 0x02000000) === 0;
};
...
const LightingLUTInputSelection = function LightingLUTInputSelection(code) {
    ...
    this.reflectB = new PICA.LightingLUTInputSelectionChoice((code >> 16) & 7);
    this.reflectG = new PICA.LightingLUTInputSelectionChoice((code >> 20) & 7);
    this.reflectR = new PICA.LightingLUTInputSelectionChoice((code >> 24) & 7);
};
...
const LightingLUTInputScale = function LightingLUTInputScale(code) {
    ...
    this.reflectB = new PICA.LightingLUTInputScaleMode((code >> 16) & 7);
    this.reflectG = new PICA.LightingLUTInputScaleMode((code >> 20) & 7);
    this.reflectR = new PICA.LightingLUTInputScaleMode((code >> 24) & 7);
};
