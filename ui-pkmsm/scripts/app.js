...
App.prototype.openModel = function (id, from) {
    ...
    this.loadModel(id, (error, result) => {
        ...
        // const m3dBeforeRender = (renderer, scene, camera, geometry, material, group) => {
        ...
        //     // world scale
        //     material.uniforms.worldScales.value.set(scale, scale, scale, 1);
        ...
        //     // texture 1
        //     if (material.uniforms.map2.value) {
        ...
        //     // texture 2
        //     if (material.uniforms.map3.value) {
        ...
        //     // bone matrices
        //     if (skeleton) {
        //         let boneMatrices = skeleton.m3dSkeleton.boneMatrices;
        //         let looper = 0;
        //         while (looper < jsonMesh.bones.length) {
        //             let index = jsonMesh.bones[looper] * 16;
        ...
        //             ambientLight.color.r, ambientLight.color.g, ambientLight.color.b, ambientLight.intensity);
        //     }
        ...
        //     // patch for direct normal
        //     // material.uniforms.useDirectNormal.value = false; //jsonMaterial.useDirectNormal;
